	...
	<body>
		...
		<div id="show-person" class="content scaffold-show" role="main">
			...
			<ol class="property-list person">
				...
				<g:if test="${person?.fullName}">
				<li class="fieldcontain">
					<span id="fullName-label" class="property-label"><g:message code="person.fullName.label" default="Full Name" /></span>
					
						<span class="property-value" aria-labelledby="fullName-label"><g:fieldValue bean="${person}" field="fullName"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${person?.jobTitle}">
				<li class="fieldcontain">
					<span id="jobTitle-label" class="property-label"><g:message code="person.jobTitle.label" default="Job Title" /></span>
					
						<span class="property-value" aria-labelledby="jobTitle-label"><g:fieldValue bean="${person}" field="jobTitle"/></span>
